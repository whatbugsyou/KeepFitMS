...
function showGoods(res) {
	...
	$.each(res.goods, function (index, goods) {
		...
		content += "<td ><i class='layui-icon layui-btn layui-btn-primary layui-btn-sm' style='font-size: 22px;' onclick='changeStatus(" + goods.goods_id + "," +goods.goods_num+","+ goods.goods_status + ")'>&#xe642;</i>  " +
...
//改变状态
function changeStatus(id, num,status) {
	if(num!=0){
