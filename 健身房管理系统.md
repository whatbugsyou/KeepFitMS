...
CREATE TABLE `product`  (
  ...
  `pro_pic varchar(50) NULL DEFAULT NULL`
...
| bc_mname varchar(20) NOT NULL           | 购课会员名称 |
| bc_cname varchar(20) not null           | 课程名称     |
| bc_time varchar(255) not null           | 购课时间     |
| bc_coach varchar(20) not null           | 教练名称     |

```mariadb
CREATE TABLE `bcourse` (
  `bc_id` int(4) NOT NULL AUTO_INCREMENT,
  `bc_mname` varchar(20) NOT NULL,
  `bc_cname` varchar(20) NOT NULL,
  `bc_time` varchar(255) NOT NULL,
  `bc_coach` varchar(20) NOT NULL,
  PRIMARY KEY (`bc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8
```
